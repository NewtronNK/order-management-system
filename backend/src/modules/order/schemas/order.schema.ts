...
export enum Status {DRAFT = 'draft', INPROGRESS = 'in progress', ONDELIVERY = 'on delivery', 
    PACKAGEPROBLEM = 'package problem', SUCCESS = 'success', BOUNCEBACK = 'bounce back', CANCEL = 'cancel'};
export enum Payment {QRPAYMENT = 'QR Payment', CASH = 'cash on delivery', BANK = 'bank transfer'};
